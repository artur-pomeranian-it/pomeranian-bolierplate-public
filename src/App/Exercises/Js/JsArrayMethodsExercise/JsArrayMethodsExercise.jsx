...
export const JsArrayMethodsExercise = () => {
  function excercise1() {
    function sameNumbers(tablica1, tablica2) {
      // TODO:
      return tablica1.filter(function (value) {
        return tablica2.some(function (value2) {
          return value2 === value;
        });
      });
    }
  ...
  function excercise3() {
    ...
    console.log('Excercise 3 result: ', JSON.stringify(result));
  }
  ...
  function excercise5() {
    function getNames(tablicaObiektow) {
      // TODO:
      return tablicaObiektow.map(function (element) {
        return element.name;
      });
    }
