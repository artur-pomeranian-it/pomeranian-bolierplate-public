...
export const JsArraysBasics = () => {
  ...
  function exampleArrayConcatenation() {
    ...
    const wynik = { jeden, dwa, jedenDwa, dwaJeden, jedenDwaFlat, uwaga };
    return wynik;
  }
  ...
  function exampleSort() {
    const tablica = ['Poland', 'Mexico', 'USA', 'Kanada', 'Italy'];
    const tablica2 = [1, 6, 7, 4];
    // const wynik = tablica.sort(function (piersza, druga) {
    //   return piersza.localeCompare(druga) * -1;
    // });
    const wynik = tablica2.sort(function (pierwsza, druga) {
      return (pierwsza - druga) * -1;
    });
    return wynik;
  }
