  ...
  return (
    <div>
          ...
          <div className="mole__row-container">
            ...
            {MOLES.map((item) => (
              <Button
                key={item.label}
                value={item.label}
                variant={item.molesNo === molesNo ? 'secondary' : 'primary'}
      ...
      <dir onClick={() => setScore((currentScore) => currentScore + 1)}>
        Dummy Kret
        <Tile hasMole />
        <Tile hasMole background="correct" />
        <Tile hasMole background="incorrect" />
        <Tile background="correct" />
        <Tile background="incorrect" />
      </dir>
    </div>
  );
};
